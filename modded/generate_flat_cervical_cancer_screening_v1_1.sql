...
BEGIN
    ...
    CREATE TABLE IF NOT EXISTS flat_cervical_cancer_screening (
        ...
        observations_from_positive_via VARCHAR(200),
        ...
        other_follow_up_plan VARCHAR(150),
        -- Next Appointment
        ...
        -- dysp_past_treatment_non-coded VARCHAR(100),
        -- Colposcopy Findings
        ...
        -- dysp_procedure_done_non_coded VARCHAR(250),
        -- Management Plan
        dysp_management_plan VARCHAR(150),
        -- dysp_management_plan_non_coded VARCHAR(100),
        -- Assessment
  ...
  IF (@query_type = "build") THEN
    ...
    WHILE @person_ids_count > 0 DO
        ...
        SET @dyn_sql = CONCAT(
          ...
          SET @observations_from_positive_via := null;
          ...
          (select 
              ...
              case
                 ...
                 when t1.encounter_type = 69 and obs regexp "!!10402=885!!" then @screening_method := 3 -- Pap smear
                 when t1.encounter_type = 69 and obs regexp "!!10402=2322!!" then @screening_method := 4 -- HPV
            ...
            case
              ...
              case
                 when t1.encounter_type = 69 and obs regexp "!!1915=" then @other_follow_up_plan := GetValues(obs, 1915)
                  else @other_follow_up_plan := null
              end as other_follow_up_plan,
              case
          ...
          SELECT @total_rows_written;
            ...
            '(select
              ...
              screening_method,
              via_test_result,
              observations_from_positive_via,
              ...
              gynp_biopsy_pap_smear_results_date,
